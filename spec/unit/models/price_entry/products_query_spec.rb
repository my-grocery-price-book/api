...
describe PriceEntry::ProductsQuery do
  describe 'execute' do
    ...
    it '10 limit default on name'  do
      ...
      expect(subject.execute.map { |p| p[:generic_name] }).to eql(['Hello 0', 'Hello 1', 'Hello 2', 'Hello 3',
    ...
    it '10 limit default on quanity_unit and name' do
      ...
      name_and_quanity_unit_array = subject.execute.map { |p| p[:generic_name] + p[:quanity_unit] }
    ...
    it '3 price limit'  do
      ...
      expect(subject.execute.first[:prices]).to eql([{ generic_name: 'Soda', store: 'store', location: 'Hello 0',
    ...
    it '3 price limit'  do
      ...
      expect(subject.execute.last[:prices]).to eql([{ generic_name: 'N2', store: 'store', location: 'Hello 0',
