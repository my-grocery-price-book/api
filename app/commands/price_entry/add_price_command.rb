...
module PriceEntry
  ...
  class AddPriceCommand
    def initialize(store:, location:, product_brand_name:, quantity:,
                   ...
                   generic_name:, expires_on:, extra_info:, shopper_id:, region:)
      @params = { generic_name: generic_name, store: store, location: location, product_brand_name: product_brand_name,
                  quantity: quantity, package_size: package_size, package_unit: package_unit, region: region,
                  ...
                  price_per_package_unit: total_price.to_f / package_size.to_f }
    end
